...
native_handle_t* SprdDisplayPlane:: createPlaneBuffer(int index)
{
    ...
    if (index < 0)
    {
     ...
     GraphicBufferAllocator::get().allocate(mWidth, mHeight, mFormat,1, mPlaneUsage, (buffer_handle_t*)&BufHandle,
                                            &stride, getUniqueId(),"createPlaneBuffer");
    if (BufHandle == NULL)
    {
