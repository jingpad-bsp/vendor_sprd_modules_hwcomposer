...
private:
    ...
    SprdUtilSource   *mAcceleratorSource;
    ...
    int setupYuvTexSurface(SprdHWLayer *Layer, native_handle_t *TragetHandle, sp<GraphicBuffer>& Source, sp<GraphicBuffer>& Target);
