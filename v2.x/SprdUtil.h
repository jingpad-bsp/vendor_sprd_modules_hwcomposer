...
#ifdef USE_ADF_DISPLAY
#include "../dpu/DpuDeviceAdf.h"
#else
#include "../dpu/DpuDeviceDrm.h"
#endif
#endif
...
class SprdUtil {
 public:
  ...
  inline void UpdateFBInfo(FrameBufferInfo *FBInfo) {
    mFBInfo = FBInfo;
    if (mDpuDev && mDpuDev->updateDisplaySize) {
      mDpuDev->updateDisplaySize(mDpuDev, FBInfo->fb_width, FBInfo->fb_height);
    }
