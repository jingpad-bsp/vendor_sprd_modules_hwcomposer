...
{
    ALOGD("OverlayNativeWindow::~OverlayNativeWindow done.");
}
        ...
        int what, int* value)
{
    ...
    switch (what) {
        ...
        case NATIVE_WINDOW_MAX_BUFFER_COUNT:
             *value = self->mNumBuffers;
             return NO_ERROR;
        default:
             ALOGE("OverlayNativeWindow::query(): command not support");
             break;
    }
    return BAD_VALUE;
        ...
        int operation, ...)
{
    ...
    switch (operation) {
        ...
        case NATIVE_WINDOW_SET_SCALING_MODE:
            ALOGE("OverlayNativeWindow::perform(): operation %d INVALID_OPERATION",operation);
            return INVALID_OPERATION;
        default:
            ALOGE("OverlayNativeWindow::perform(): operation %d not support",operation);
            break;
    }
